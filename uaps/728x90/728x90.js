...
lib.ssMetadata = [
		{name:"728x90_atlas_1", frames: [[0,0,728,90],[730,36,215,21],[730,0,200,34],[0,92,728,90]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,2,200,34);
...
p.nominalBounds = new cjs.Rectangle(0,0,215,21);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(119.5,57.5,1,1,0,0,0,107.5,10.5);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:129.5,alpha:1},29,cjs.Ease.get(1)).wait(212));

	// Layer_2
	this.instance_2 = new lib.Symbol23("synched",0);
	this.instance_2.setTransform(372,35,1,1,0,0,0,100,17);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({_off:false},0).to({y:45,alpha:1},30,cjs.Ease.get(1)).wait(182));
