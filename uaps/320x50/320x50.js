...
lib.ssMetadata = [
		{name:"320x50_atlas_1", frames: [[0,0,320,50],[0,104,187,19],[0,52,320,50]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,187,19);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(99.5,33.5,1,1,0,0,0,93.5,9.5);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:103.5,alpha:1},29,cjs.Ease.get(1)).wait(211));
