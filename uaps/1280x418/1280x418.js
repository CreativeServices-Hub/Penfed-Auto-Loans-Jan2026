...
lib.ssMetadata = [
		{name:"1280x418_atlas_1", frames: [[0,0,1280,418],[0,1189,736,31],[738,1189,458,44],[0,420,1280,418],[0,840,1280,347]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,458,44);
...
p.nominalBounds = new cjs.Rectangle(0,0,736,31);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib.NEW1280x418b();
...
p.nominalBounds = new cjs.Rectangle(0,0,1280,347);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(287.5,167,1,1,0,0,0,229,22);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({x:303,alpha:1},29,cjs.Ease.get(1)).wait(211));

	// Layer_4
	this.instance_2 = new lib.Symbol44("synched",0);
	this.instance_2.setTransform(443,222,1,1,0,0,0,368,15.5);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(29).to({_off:false},0).to({y:237.5,alpha:1},30,cjs.Ease.get(1)).wait(181));
	...
	this.instance_4.setTransform(640,173.5,1,1,0,0,0,640,173.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({scaleX:1.0391,scaleY:1.0391,y:173.55},239).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(615,202.3,690,215.7);
// library properties:
lib.properties = {
